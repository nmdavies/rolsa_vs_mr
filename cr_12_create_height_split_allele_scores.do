...
use "final_full_snps_clean.dta",clear
drop _m
...
//Create two scores for height:
replace trait ="Height || GIANT || 2014 || SD (m)2" if _n>2286 & _n<2600
...
keep n_eid allele_score_25 allele_score_26 

//Label allele scores

keep n_eid allele_score_25 allele_score_26 
rename allele_score_25 allele_score_height_1
rename allele_score_26 allele_score_height_2	
...
save "workingdata/full_sample_height_allele_scores",replace
