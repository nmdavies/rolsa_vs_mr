...
use "rawdata/biobank_phenotypes_nmd_150417.dta", clear
...
cap prog drop merge_var1
prog def merge_var1
replace `1'_0_1=`1'_1_1 if (`1'_0_1==.|`1'_0_1<0 )& (`1'_1_1>0 & `1'_1_1!=.)
end

cap prog drop merge_var2
prog def merge_var2
replace `1'_0_2=`1'_1_2 if (`1'_0_2==.|`1'_0_2<0 )& (`1'_1_2>0 & `1'_1_2!=.)
end
...
foreach i in `r(varlist)'{
	...
	replace eduyears=19 if `i'==5 & (eduyears<19|eduyear==.) 
	replace eduyears=15 if `i'==4 & (eduyears<15|eduyear==.)
	replace eduyears=13 if `i'==2 & (eduyears<13|eduyear==.)
	replace eduyears=10 if (`i'==3|`i'==4) & (eduyears<10|eduyear==.)
...
joinby n_eid using "workingdata/covariates",unmatched(master) _merge(XXX)
drop if XXX!=3
drop XXX
...
save "workingdata/cleaned_biobank_outcomes",replace
